...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.labelDropdown.addItems(["PLANKHOLD_POSE", "PLANKHOLD_REP",
                                     "SIDEPLANKRIGHT_POSE", "SIDEPLANKRIGHT_REP",
                                     "SIDEPLANKLEFT_POSE", "SIDEPLANKLEFT_REP",
                                     "FULLSQUAT_POSE", "FULLSQUAT_REP",
                                     "NEGATIVE_NONE"])
